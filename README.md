...
__Данный проект больше не развивается. Он перерос в другой - [HMSEditor_addon](https://github.com/WendyH/HMSEditor_addon).__
...
6. Далее, в программе "Домашний медиа-сервер", в настройках выбрать категорию "События";
